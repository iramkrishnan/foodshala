...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('Restaurant Register') }}</div>

                    <div class="card-body">
                        <form method="POST" action="{{ route('post.restaurant.register') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select id="cuisine" class=" form-control py-1 @error('cuisine') is-invalid @enderror" name="cuisine" value="{{ old('cuisine') }}" required autocomplete="cuisine" autofocus>
