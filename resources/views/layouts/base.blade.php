...
<header class="text-gray-700 body-font">
    <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        <nav class="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center">
            ...
            <a class="mr-5 hover:text-gray-900" href="{{route('get.restaurant.register')}}">Restaurant Register</a>
        ...
        @if(\Illuminate\Support\Facades\Auth::guard('restaurant')->check() | \Illuminate\Support\Facades\Auth::guard('customer')->check())
            <nav>
...
<footer class="text-gray-700 body-font mt-5">
