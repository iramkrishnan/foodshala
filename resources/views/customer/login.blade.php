...
@section('content')
    ...
    <section class="text-gray-700 body-font">
        <form method="POST" action="{{ route('post.customer.login') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="container px-5 py-10 mx-auto flex flex-wrap items-center">
                ...
                <div class="lg:w-2/6 md:w-1/2 bg-gray-200 rounded-lg p-8 flex flex-col md:mx-auto w-full mt-10 md:mt-0">
                    <h1 class="text-gray-900 text-lg font-medium title-font mb-5 text-center"><strong>Customer Login</strong>
                    </h1>
