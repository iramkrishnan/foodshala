                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('post.menu.add') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <label for="menu_item"
                                       class="col-md-4 col-form-label text-md-right">{{ __('Menu Item') }}</label>

                                <div class="col-md-6">
                                    <input id="menu_item" type="text"
                                           class="form-control @error('menu_item') is-invalid @enderror"
                                           name="menu_item" value="{{ old('menu_item') }}" required
                                           autocomplete="menu_item" autofocus>
